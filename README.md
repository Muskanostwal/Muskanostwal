...
<!-- SOCIAL BADGES -->
<p align="center">
  <a href="https://linkedin.com/in/muskan-ostwal">
    <img src="https://img.shields.io/badge/LinkedIn-0077B5?style=for-the-badge&logo=linkedin&logoColor=white"/>
  </a>
  <a href="mailto:ostwalmuskan@gmail.com">
    <img src="https://img.shields.io/badge/Email-D14836?style=for-the-badge&logo=gmail&logoColor=white"/>
  </a>
  <a href="https://github.com/Muskanostwal">
...
## 🍽️ Food Restaurant Review & Finder Website  
**Tech Stack:** React.js, Node.js, MongoDB, Google Maps API  
🗺️ Google Maps–integrated platform to discover nearby eateries  
...
♻️ Helps students buy/sell/exchange books easily  
...
**June 2025 – Aug 2025**  
✔ MERN blogging platform using MVC  
✔ Secure Passport.js authentication  
✔ Modular backend & optimized CRUD operations  
...
`Node.js` • `React.js` • `OpenCV` • `YOLOv8` • `TensorFlow`

### ⭐ Tools / Platforms  
`Git` • `GitHub` • `VS Code` • `Postman` • `Power BI` • `Agile`
...
🏅 Research Publication (ICASDGAI-2025):  
*“An Analysis of Modern Online Applications with a Focus on Usability and Security”*
